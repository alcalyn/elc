 ...
 * @ORM\Entity(repositoryClass="EL\Bundle\CoreBundle\Repository\CountryLangRepository")
 */
class CountryLang
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EL\Bundle\CoreBundle\Entity\Country")
     ...
     * Set country
     *
     * @param \EL\Bundle\CoreBundle\Entity\Country $country
     * @return CountryLang
     */
    public function setCountry(\EL\Bundle\CoreBundle\Entity\Country $country)
    {
     ...
     * Get country
     *
     * @return \EL\Bundle\CoreBundle\Entity\Country 
     */
