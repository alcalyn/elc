 ...
 * @ORM\Entity(repositoryClass="EL\Bundle\CoreBundle\Repository\GameRepository")
 */
class Game extends AbstractLangEntity implements \JsonSerializable
{
     ...
     * 
     * @ORM\ManyToOne(targetEntity="EL\Bundle\CoreBundle\Entity\Category", inversedBy="games")
     ...
     * 
     * @ORM\OneToMany(targetEntity="EL\Bundle\CoreBundle\Entity\GameLang", mappedBy="game")
     ...
     * @var \Doctrine\Common\Collections\ArrayCollection
     * 
     * @ORM\OneToMany(targetEntity="EL\Bundle\CoreBundle\Entity\GameVariant", mappedBy="game")
     * @ORM\JoinColumn(nullable=true)
     */
     ...
     * @return Game
     */
    public function setCategory(\EL\Bundle\CoreBundle\Entity\Category $category = null)
    {
     ...
     * Add langs
     *
     * @param \EL\Bundle\CoreBundle\Entity\GameLang $langs
     * @return Game
     */
    public function addLang(\EL\Bundle\CoreBundle\Entity\GameLang $langs)
    {
        $this->langs[] = $langs;
     ...
     * @param \EL\Bundle\CoreBundle\Entity\GameLang $langs
     */
    public function removeLang(\EL\Bundle\CoreBundle\Entity\GameLang $langs)
    {
     ...
     * Add gameVariants
     *
     * @param \EL\Bundle\CoreBundle\Entity\GameVariant $gameVariants
     * @return Game
     */
    public function addGameVariant(\EL\Bundle\CoreBundle\Entity\GameVariant $gameVariants)
    {
     ...
     * @param \EL\Bundle\CoreBundle\Entity\GameVariant $gameVariants
     */
    public function removeGameVariant(\EL\Bundle\CoreBundle\Entity\GameVariant $gameVariants)
    {
