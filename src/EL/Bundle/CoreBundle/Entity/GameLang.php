 ...
 * @ORM\Entity(repositoryClass="EL\Bundle\CoreBundle\Repository\GameLangRepository")
 */
class GameLang
{
    /**
     ...
     * @var Game
     * 
     * @ORM\ManyToOne(targetEntity="EL\Bundle\CoreBundle\Entity\Game", inversedBy="langs")
