 ...
 * @ORM\Entity(repositoryClass="EL\Bundle\CoreBundle\Repository\ScoreRepository")
 */
class Score
{
    /**
     ...
     * @var GameVariant
     * 
     * @ORM\ManyToOne(targetEntity="EL\Bundle\CoreBundle\Entity\GameVariant", inversedBy="scores")
     * @ORM\JoinColumn(nullable=false)
     */
    private $gameVariant;
