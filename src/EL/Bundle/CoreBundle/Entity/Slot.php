 ...
 * @ORM\Entity(repositoryClass="EL\Bundle\CoreBundle\Repository\SlotRepository")
 */
class Slot implements \JsonSerializable
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EL\Bundle\CoreBundle\Entity\Party", inversedBy="slots", cascade={"persist"})
     ...
     * @return Slot
     */
    public function setPlayer(\EL\Bundle\CoreBundle\Entity\Player $player = null)
    {
        $this->player = $player;
     ...
     * @return Slot
     */
    public function setParty(\EL\Bundle\CoreBundle\Entity\Party $party)
    {
        $this->party = $party;
