 ...
 * @ORM\Entity(repositoryClass="EL\CoreBundle\Repository\EloRepository")
 */
class Elo
{
    /**
     ...
     * Set opponent
     *
     * @param \EL\CoreBundle\Entity\Player $opponent
     * @return Elo
     */
    public function setOpponent(\EL\CoreBundle\Entity\Player $opponent)
    {
